...
// قوائم لتوليد أكثر من 1000 نتيجة فريدة
const prefixes = [
    "مستقبلك العاطفي يحمل لك", "ستتزوج قريباً من", "القدر يخبئ لك مع", 
    "سترتبط قريباً بـ", "نصيبك القادم سيكون", "سينير حياتك قريباً", 
    "ستلتقي قريباً بـ", "مستقبلك يحمل لك", "ستعيش قصة حب مع"
];
    ...
    if (!resultId) {
        return res.send(`
            ...
            <head>
                ...
                <meta property="og:description" content="أجب عن الأسئلة واكتشف توقعات زواجك ورسالة روحك القادمة من بين آلاف الاحتمالات!">
            ...
            <body>
                <div class="card">
                    <h2 style="color: #6b4423; font-family: 'Amiri', serif;">🌿 اختبار الروح والقلوب</h2>
                    <p style="color: #8c7355; line-height: 1.6;">اكتشف رسالة روحك وشريك حياتك القادم من بين أكثر من 1000 احتمال فريد...</p>
    ...
    return `
        ...
        <head>
            ...
            <style>
                ...
                .card { background: #fffdf9; max-width: 500px; margin: auto; padding: 25px; border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.05); border: 1px solid #f0eae1; box-sizing: border-box; }
                
                .title-header { font-size: 20px; color: #5c4033; font-weight: bold; margin-bottom: 20px; }
                ...
                .retry-btn { display: block; width: 100%; background: #d4a373; color: white; text-decoration: none; padding: 14px; font-size: 16px; border-radius: 12px; margin-bottom: 20px; font-weight: bold; box-sizing: border-box; transition: background 0.3s; box-shadow: 0 4px 10px rgba(212, 163, 115, 0.3); }
                .retry-btn:hover { background: #bc6c25; }

                .share-title { font-size: 14px; margin: 15px 0 12px 0; color: #8c7355; font-weight: bold; border-top: 1px solid #f0eae1; padding-top: 15px; }
        ...
        <body>
            <div class="card">
                <div class="title-header">✨ رسالة روحك اليوم:</div>
